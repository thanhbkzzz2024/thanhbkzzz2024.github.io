...
var audio = new Audio("bai1.mp3");
var audio1 = new Audio("bai2.mp3")

const config = {
    birthdate: 'Sep 05, 2023',
    name: 'Thảo Vy - Bé Bê '
};
...
function musicPlay() {
    document.getElementById('au123').play();
...
x = setInterval(function() {
    ...
    if (distance > 0) {
        ...
        function showfireworks() {
            ...
            audio.play();
            var temp1 = document.getElementById('au123')
            temp1.pause();

            setTimeout(function() {
                window.location.href = 'https://thanhbkzzz2022.github.io/';
            }, 70000);
        }
